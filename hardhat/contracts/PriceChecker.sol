...
contract PriceChecker {
    ...
    function swapExactOutputSingle() external returns (uint256 amountPayed) {
        if (totalIn >= amountIn) {
            ...
            fulfilled = true;
        } // I created this separate varaible to read from, I can read variables, just cant see return vlues like you
        //you could do this
        //it wouldn't  pretty tho
        return 0;
    }
}
